# 🤖 agent-contracts - Build AI Agents Easily
...
After installing, here’s how to get started with your first agent:

1. **Open the Application**  
   Click the application icon to launch.

2. **Create a New Project**  
   Use the menu to start a new project. You’ll find options to name your project and define the scope.
